...
Let a vector, 
\begin{align}
    \vec{X} = \myvec{x\\y} \in \vec{R}^2 \\
    \vec{T} : \vec{R}^2 \xrightarrow{} \vec{R}^2 \\
\end{align}
Consider, 
\begin{align}
    \vec{T}\brak{\vec{X}} = \vec{M}\vec{X} \\
    \implies \vec{T}\brak{\vec{X}} = \myvec{0\\x} 
\end{align}
such that,
\begin{align}
    \vec{M} = \myvec{0&0\\1&0} \\
    \implies \vec{T} \ne 0 \label{t}
\end{align}
Now, since $\vec{T}$ is a linear operator on $\vec{R}^2$, 
\begin{align}
...
\end{align}
Thus $\vec{T}^2$ is also a linear operator on $\vec{R}^2$ such that, 
\begin{align}
    \vec{T}^2 : \vec{R}^2 \xrightarrow{} \vec{R}^2
\end{align}
\begin{align}
    \vec{T}^2\brak{\vec{X}} = \vec{T}\brak{\vec{T}\brak{\vec{X}}} =\vec{T}\brak{\vec{M}\vec{X}} = \vec{M}^2\vec{X} \\

...
\begin{align}
    \vec{Y} &= \myvec{ 3 & 2 \\ 1 & 4 }\notag\\
    \implies\myvec{\vec{O} & \vec{I}}\myvec{\vec{X} \\ \vec{Y}} &= \myvec{ 3 & 2 \\ 1 & 4 } &= \vec{M}
\end{align}
...
\begin{align}
    ...
    &= \myvec{1 & 0 \\ -3 & 2} &= \vec{N}
\end{align}
Combining equations (2.0.13) and (2.0.14) into a single matrix equation and constructing the augmented matrix, 
\begin{align}
    \myvec{0 & I & M \\ 2I & I &  N}
\end{align}
Transforming (2.0.15) using row reduction, 
\begin{align}
